...
int main(int argc, char *argv[])
{
  ...
  std::string objFile = "../assets/diamond.obj";
  tinyobj::ObjectReaderConfig reader_config;
  read_config.mtl_search_path = "./";
  ...
  for (size_t s = 0; s < shapes.size(); s++) {
    ...
    for (size_t = 0; f < shapes[s].mesh.num_faces_vertices.size(); f++) {
